...
surf_dict = {
            ...
            'yield' : 500.e6, # [Pa] yield stress divided by 2.5 for limiting case
            'mrho' : 3.e3,          # [kg/m^3] material density
            'fem_origin' : 0.35,    # normalized chordwise location of the spar
            't_over_c_cp' : np.array([0.18]),      # maximum airfoil thickness
...
indep_var_comp.add_output('load_factor', val=2.5)
